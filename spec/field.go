...
func NewField(
	...
	var o *graphqlv1.GraphqlField
	if opts := d.GetOptions(); opts != nil {
		if ext := proto.GetExtension(opts, graphqlv1.E_Field); ext != nil {
			if field, ok := ext.(*graphqlv1.GraphqlField); ok {
				o = field
			}
		}
	}
