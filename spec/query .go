...
func (q *Query) IsResolver() bool {
	return q.Schema.GetType() == graphqlv1.GraphqlType_GRAPHQL_TYPE_RESOLVER
}
...
func (q *Query) Request() *graphqlv1.GraphqlRequest {
	return q.Schema.GetRequest()
}

func (q *Query) Response() *graphqlv1.GraphqlResponse {
...
func (q *Query) QueryType() string {
	...
	if resp := q.Response(); resp != nil {
		if resp.GetRequired() {
			typeName = "graphqlv1.NewNonNull(" + typeName + ")"
		}
	}
	return typeName
}
